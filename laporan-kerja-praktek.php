<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $result = $stmt->fetch(PDO::FETCH_ASSOC);
        if ($result) header("Location: laporan-kerja-praktek.php?id=" . $result['id']);
    }
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>E-Library | Laporan Kerja Praktek</title>
            ...
            $(document).ready(function () {
                ...
                $("#lastDocumentForm").validate({
                    ...
                    messages: {
                        surat_validasi: {
                            required: "Dokumen tidak boleh kosong.",
                            extension: "File yang diterima dan pdf"
                        },
                        lkp_document: {
                            required: "Dokumen tidak boleh kosong.",
                            extension: "File yang diterima dan pdf"
                    ...
                    submitHandler: function(form) {
                        ...
                        formData.append('tipe_dokumen', 'LPK');
                        $.ajax({
                            method:"POST",
